defmodule Ineedthis.Images.Image do
  use Ecto.Schema
  ...
  alias Ineedthis.ImageHides.ImageHide
  ...
  alias Ineedthis.Images.TagDiffer
  alias Ineedthis.Images.TagValidator
  alias Ineedthis.Images.DnpValidator
