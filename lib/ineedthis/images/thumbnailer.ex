defmodule Ineedthis.Images.Thumbnailer do
  @moduledoc """
  Prevewing and thumbnailing logic for Images.
  """

  alias Ineedthis.DuplicateReports
  alias Ineedthis.ImageIntensities
  alias Ineedthis.Images.Image
  alias Ineedthis.Processors
  alias Ineedthis.Analyzers
  alias Ineedthis.Sha512
  ...
  defp image_file_root,
    do: Application.get_env(:ineedthis, :image_file_root)

  defp image_thumbnail_root,
    do: Application.get_env(:ineedthis, :image_file_root) <> "/thumbs"

  defp image_url_root,
    do: Application.get_env(:ineedthis, :image_url_root)
end
