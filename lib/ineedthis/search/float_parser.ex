defmodule Ineedthis.Search.FloatParser do
  import NimbleParsec

  defp to_number(input), do: Ineedthis.Search.Helpers.to_number(input)
  defp range(input), do: Ineedthis.Search.Helpers.range(input)
