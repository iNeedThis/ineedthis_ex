defmodule IneedthisWeb.CompromisedPasswordCheckPlug do
  ...
  defp password_compromised?(password) do
    ...
    case Ineedthis.Http.get(make_api_url(prefix)) do
  ...
  defp pwned_passwords_enabled? do
    Application.get_env(:ineedthis, :pwned_passwords) != false
  end
end
