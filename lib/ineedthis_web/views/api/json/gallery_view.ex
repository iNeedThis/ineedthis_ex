defmodule IneedthisWeb.Api.Json.GalleryView do
  use IneedthisWeb, :view

  def render("index.json", %{galleries: galleries, total: total} = assigns) do
    %{
      galleries:
        render_many(galleries, IneedthisWeb.Api.Json.GalleryView, "gallery.json", assigns),
      total: total
    }
  end

  def render("show.json", %{gallery: gallery} = assigns) do
    %{gallery: render_one(gallery, IneedthisWeb.Api.Json.GalleryView, "gallery.json", assigns)}
  end
