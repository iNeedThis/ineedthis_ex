defmodule IneedthisWeb.UserAttributionView do
  use IneedthisWeb, :view
  use Bitwise

  alias Ineedthis.Attribution
  alias IneedthisWeb.AvatarGeneratorView
  ...
  defp avatar_url_root do
    Application.get_env(:ineedthis, :avatar_url_root)
  end

  defp anonymous_name_salt do
    Application.get_env(:ineedthis, :anonymous_name_salt)
    |> to_string()
  end
end
